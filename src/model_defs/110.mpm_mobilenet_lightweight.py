# -*- coding: utf-8 -*-
"""
MPM MobileNetV2 Lightweight 모델 (Grayscale 경량화 버전)
- 96×96 Grayscale 입력 (1채널)
- Custom MobileNetV2(0.5) Backbone (torchvision 독립)
- CBAM Attention (Channel + Spatial)
- Lightweight Self-Attention (2 heads)
...
SAVE_FILE_NAME = f'mpm_110_mobilenet_lightweight_{IMAGE_SIZE[0]}'
...
class LightweightSelfAttention(nn.Module):
    """Lightweight Self-Attention (2 heads, expansion=2)"""
...
class MPMMobileNetLightweightModel(nn.Module):
    ...
    MODEL_NAME = "mpm_mobilenet_lightweight"
